...
;
load data inpath "/origin_data/edu/log/2025-03-01" into table ods_log partition (dt = '2025-03-01');
load data inpath "/origin_data/edu/log/2025-03-02" into table ods_log partition (dt = '2025-03-02');
load data inpath "/origin_data/edu/log/2025-03-03" into table ods_log partition (dt = '2025-03-03');
----------------业务-----------------
-- 1 活动信息表
...
load data inpath "/origin_data/gmalll/db/base_region/2025-02-01" into table ods_base_region;
load data inpath "/origin_data/gmalll/db/base_province/2025-02-01" into table ods_base_province;